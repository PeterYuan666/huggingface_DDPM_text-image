...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start;">  
    <div style="width: 45%; margin-right: 10%; margin-bottom: 20px;"> <!-- Added margin-bottom for vertical spacing -->  
        ...
        <p style="font-weight: bold; font-size: 18px; margin-top: 10px;">Page1: "Two birds sitting on the cake" generated by diffusion models</p>  
    </div>  
    <div style="width: 45%; margin-bottom: 20px;"> <!-- Added margin-bottom for vertical spacing -->  
        ...
        <p style="font-weight: bold; font-size: 18px; margin-top: 10px;">Page2: "A watermelon tree" generated by diffusion models</p>  
    </div>  
</div>

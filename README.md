...
<div style="display: flex; flex-wrap: wrap; align-items: flex-start;">  
    <div style="width: 45%; margin-right: 10%; margin-bottom: 20px;"> <!-- Added margin-bottom for vertical spacing -->  
        <img src="https://github.com/PeterYuan666/huggingface_DDPM_text-image/blob/785388add0e167d33e481dd082f6aaeb349b28ab/generate_picture_collection/a%20photo%20of%20two%20birds%20sitting%20on%20the%20cake.png" alt="Two Birds Sitting on Cake 1" style="width: 90%; height: auto;">  
        <p style="font-weight: bold; font-size: 18px; margin-top: 10px;">Page Left: "Two birds sitting on the cake" generated by diffusion models</p>  
    </div>  
    <div style="width: 45%; margin-bottom: 20px;"> <!-- Added margin-bottom for vertical spacing -->  
        <img src="https://github.com/PeterYuan666/huggingface_DDPM_text-image/blob/56bee1701f210a43735e89a1a86db440a606b1d8/generate_picture_collection/a%20photo%20of%20watermelon%20tree.png" alt="Watermelon Tree" alt="Watermelon Tree" style="width: 90%; height: auto;">  
        <p style="font-weight: bold; font-size: 18px; margin-top: 10px;">Page Right: "A watermelon tree" generated by diffusion models</p>  
    </div>  
</div>
